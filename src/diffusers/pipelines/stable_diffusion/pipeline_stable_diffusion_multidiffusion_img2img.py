...
from ...utils import is_accelerate_available, logging, randn_tensor, replace_example_docstring, PIL_INTERPOLATION, \
    deprecate
...
class StableDiffusionPipelineMultidiffusionImageToImage(DiffusionPipeline):
    r"""
    ...
    def __call__(
        ...
        image = torch.nn.functional.interpolate(image, scale_factor=upscale, mode="bilinear")
        ...
        views = self.get_views(height, width, windows_overlap=overlap)
